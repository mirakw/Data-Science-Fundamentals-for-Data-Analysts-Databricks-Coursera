...
# MAGIC -- TODO
# MAGIC
# MAGIC SELECT CAST(AVG(resting_heartrate) AS int) as avg_resting_heartrate, lifestyle
...
# MAGIC -- TODO
# MAGIC
# MAGIC SELECT CAST(percentile(resting_heartrate, 0.5) AS int) AS median_resting_heartrate
# MAGIC FROM dsfda.ht_daily_metrics
...
# MAGIC -- TODO
# MAGIC
# MAGIC SELECT COUNT(*) AS count, CAST(resting_heartrate AS int) AS resting_heartrate
# MAGIC FROM dsfda.ht_daily_metrics
# MAGIC GROUP BY resting_heartrate
...
# MAGIC
# MAGIC
# MAGIC SELECT CAST(STD(resting_heartrate) AS int) as std_resting_heartrate, lifestyle
# MAGIC FROM dsfda.ht_daily_metrics
# MAGIC GROUP BY lifestyle
...
# MAGIC -- TODO
# MAGIC
# MAGIC SELECT CAST(percentile(resting_heartrate, 0.75) - percentile(resting_heartrate, 0.25) AS int) AS iqr_resting_heartrate
# MAGIC FROM dsfda.ht_daily_metrics
# MAGIC GROUP BY lifestyle
